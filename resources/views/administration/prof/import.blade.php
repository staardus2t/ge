            ...
            <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                ...
                <li class="m-nav__item">
                    <a href="" class="m-nav__link">
                        <span class="m-nav__link-text">Importer des profs</span>
                    </a>
                </li>
            </ul>
        </div>
...
<div class="m-content">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            action="{{route('prof.import')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <!--begin::Portlet-->
                        ...
                        <div class="m-portlet__head-wrapper">
                            ...
                            <div class="m-portlet__head-tools">
                                <div class="btn-group mr-4">
                                    <a href="{{ route('prof.telecharger') }}" class="btn btn-dark  m-btn m-btn--icon m-btn--wide m-btn--md">
                                        <span>
...
<script>
    ...
    var active  = document.getElementById('import_prof');
