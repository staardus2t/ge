            ...
            <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                ...
                <li class="m-nav__item">
                    <a href="" class="m-nav__link">
                        <span class="m-nav__link-text">Cycle scolaire</span>
                    </a>
                </li>
                <li class="m-nav__separator">-</li>
                <li class="m-nav__item">
                    <a href="" class="m-nav__link">
                        <span class="m-nav__link-text">Liste des cycle scolaire</span>
                    </a>
                </li>
            </ul>
        </div>
            ...
            <div class="m-portlet__head-tools">
                <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                        <a href="{{ route('cycle_scolaire.create') }}" class="btn btn-primary m-btn m-btn--pill m-btn--custom m-btn--icon m-btn--air">
                            <span>
                                <i class="la la-plus-circle"></i>
                                <span>Ajouter cycle scolaire</span>
                            </span>
                        </a>
                    </li>
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable" id="list_items" >
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            {{ $cycle_scolaire->date_debut }}
                        </td>
                        <td>
                            {{ $cycle_scolaire->date_fin }}
                        </td>
                        <td>
                            {{ $cycle_scolaire->created_at }}
                        </td>
                        <td>
                            {{ $cycle_scolaire->updated_at }}
                        </td>
                        <td style="text-align:center;">
                            <span class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end"
                                    ...
                                    <form action="{{ route('cycle_scolaire.destroy', $cycle_scolaire->id)}}" method="POST" id="formDelete">
                                        @csrf
                                        @method('DELETE')
...
<script>
    var li  = document.getElementById('cycle_scolaire');
    li.setAttribute('class', 'm-menu__item m-menu__item--submenu m-menu__item--open');

    var active  = document.getElementById('index_cycle_scolaire');
