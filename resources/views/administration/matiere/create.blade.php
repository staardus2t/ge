            ...
            <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                ...
                <li class="m-nav__item">
                    <a href="" class="m-nav__link">
                        <span class="m-nav__link-text">Ajouter matière</span>
                    </a>
                </li>
            </ul>
        </div>
...
<div class="m-content">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            action="{{route('matiere.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <!--begin::Portlet-->
...
<script>
    ...
    var active  = document.getElementById('create_matiere');
