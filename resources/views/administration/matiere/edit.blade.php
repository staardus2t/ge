            ...
            <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                ...
                <li class="m-nav__item">
                    <a href="" class="m-nav__link">
                        <span class="m-nav__link-text">Modifier matière</span>
                    </a>
                </li>
            </ul>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <form class="m-form m-form--label-align-left- m-form--state-" id="m_form"
                action="{{route('matiere.update',$matiere->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <!--begin::Portlet-->
                                        ...
                                        <div class="m-form__section m-form__section--first">
                                            ...
                                            <div class="form-group m-form__group row">
                                                ...
                                                <div class="col-xl-6 col-lg-6">
                                                    <input class="form-control m-input" type="text" name="nom" value="{{ $matiere->nom_matiere }}">
                                                </div>
                                            </div>
